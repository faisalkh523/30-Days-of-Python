...
def most_spoken_languages(data, top_n=10):
    ...
    for country in data:
        language_counter.update(countries_data['language'])
...
top_languages = most_spoken_languages(countries_data, top_n=10)
top_countries = most_populated_countries(countries_data, top_n=10)
